...
export const LoansApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    apiLoansByBorrowerEvmAddressEvmAddressGet: async (
      evmAddress: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'evmAddress' is not null or undefined
      assertParamExists(
        'apiLoansByBorrowerEvmAddressEvmAddressGet',
        'evmAddress',
        evmAddress,
      )
      const localVarPath = `/api/Loans/byBorrowerEvmAddress/{evmAddress}`.replace(
        `{${'evmAddress'}}`,
        encodeURIComponent(String(evmAddress)),
      )
     ...
     * @throws {RequiredError}
     */
    apiLoansByBorrowerTzAddressTzAddressGet: async (
      tzAddress: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'tzAddress' is not null or undefined
      assertParamExists(
        'apiLoansByBorrowerTzAddressTzAddressGet',
        'tzAddress',
        tzAddress,
      )
      const localVarPath = `/api/Loans/byBorrowerTzAddress/{tzAddress}`.replace(
        `{${'tzAddress'}}`,
        encodeURIComponent(String(tzAddress)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
     ...
     * @throws {RequiredError}
     */
    apiLoansByLenderEvmAddressEvmAddressGet: async (
      evmAddress: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'evmAddress' is not null or undefined
      assertParamExists(
        'apiLoansByLenderEvmAddressEvmAddressGet',
        'evmAddress',
        evmAddress,
      )
      const localVarPath = `/api/Loans/byLenderEvmAddress/{evmAddress}`.replace(
        `{${'evmAddress'}}`,
        encodeURIComponent(String(evmAddress)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    apiLoansByLenderTzAddressTzAddressGet: async (
      tzAddress: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'tzAddress' is not null or undefined
      assertParamExists(
        'apiLoansByLenderTzAddressTzAddressGet',
        'tzAddress',
        tzAddress,
      )
      const localVarPath = `/api/Loans/byLenderTzAddress/{tzAddress}`.replace(
        `{${'tzAddress'}}`,
        encodeURIComponent(String(tzAddress)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const LoansApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiLoansByBorrowerEvmAddressEvmAddressGet(
      evmAddress: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ALoan>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiLoansByBorrowerEvmAddressEvmAddressGet(
        evmAddress,
        options,
      )
     ...
     * @throws {RequiredError}
     */
    async apiLoansByBorrowerTzAddressTzAddressGet(
      tzAddress: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ALoan>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiLoansByBorrowerTzAddressTzAddressGet(
        tzAddress,
        options,
      )
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async apiLoansByLenderEvmAddressEvmAddressGet(
      evmAddress: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ALoan>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiLoansByLenderEvmAddressEvmAddressGet(
        evmAddress,
        options,
      )
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async apiLoansByLenderTzAddressTzAddressGet(
      tzAddress: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ALoan>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiLoansByLenderTzAddressTzAddressGet(
        tzAddress,
        options,
      )
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async apiLoansUpdatePost(
      aLoan?: ALoan,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ALoan>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiLoansUpdatePost(
        aLoan,
        options,
      )
      return createRequestFunction(
...
export const LoansApiFactory = function (
  ...
  return {
    ...
    apiLoansByBorrowerEvmAddressEvmAddressGet(
      ...
      return localVarFp
        .apiLoansByBorrowerEvmAddressEvmAddressGet(evmAddress, options)
    ...
    apiLoansByBorrowerTzAddressTzAddressGet(
      ...
      return localVarFp
        .apiLoansByBorrowerTzAddressTzAddressGet(tzAddress, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    apiLoansByLenderEvmAddressEvmAddressGet(
      ...
      return localVarFp
        .apiLoansByLenderEvmAddressEvmAddressGet(evmAddress, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    apiLoansByLenderTzAddressTzAddressGet(
      ...
      return localVarFp
        .apiLoansByLenderTzAddressTzAddressGet(tzAddress, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    apiLoansUpdatePost(aLoan?: ALoan, options?: any): AxiosPromise<ALoan> {
      return localVarFp
        .apiLoansUpdatePost(aLoan, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class LoansApi extends BaseAPI {
   ...
   * @memberof LoansApi
   */
  public apiLoansByBorrowerEvmAddressEvmAddressGet(
    evmAddress: string,
    options?: AxiosRequestConfig,
  ) {
   ...
   * @memberof LoansApi
   */
  public apiLoansByBorrowerTzAddressTzAddressGet(
    tzAddress: string,
    options?: AxiosRequestConfig,
  ) {
    return LoansApiFp(this.configuration)
   ...
   * @memberof LoansApi
   */
  public apiLoansByLenderEvmAddressEvmAddressGet(
    evmAddress: string,
    options?: AxiosRequestConfig,
  ) {
    return LoansApiFp(this.configuration)
   ...
   * @memberof LoansApi
   */
  public apiLoansByLenderTzAddressTzAddressGet(
    tzAddress: string,
    options?: AxiosRequestConfig,
  ) {
    return LoansApiFp(this.configuration)
