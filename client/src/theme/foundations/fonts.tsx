...
font-weight: 400;
font-display: swap;
src: url('assets/fonts/Jakarta/PlusJakartaSans-Regular.woff2') format('woff2'), url('assets/fonts/Jakarta/PlusJakartaSans-Regular.woff') format('woff');
...
font-weight: 500;
font-display: swap;
src: url('assets/fonts/Jakarta/PlusJakartaSans-Bold.woff2') format('woff2'), url('assets/fonts/Jakarta/PlusJakartaSans-Bold.woff') format('woff');
